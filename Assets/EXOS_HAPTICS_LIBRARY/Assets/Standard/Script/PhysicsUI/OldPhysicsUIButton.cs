...
namespace exiii.Unity.PhysicsUI
{
    ...
    public class OldPhysicsUIButton : ShapeContainerBase, ITouchableScript, ITouchForceGenerator, IValueHolder<bool>
    {
        #region Inspector
        ...
        private ILinkTo<PhysicalProperties> m_LinkToPhysicalProperties;
        ...
        public override bool HasShapeData { get { return true; } }
        ...
        public override void StartInjection(IRootScript root)
        {
            ...
            m_LinkToPhysicalProperties = root.gameObject.GetComponentInChildren<ILinkTo<PhysicalProperties>>();

            if (m_LinkToPhysicalProperties == null)
            {
        ...
        {
            receiver.AddForceRatio(state.SummarizedOutput.InitialPoint, state.SummarizedOutput.Vector * m_LinkToPhysicalProperties.Value.Elasticity);
