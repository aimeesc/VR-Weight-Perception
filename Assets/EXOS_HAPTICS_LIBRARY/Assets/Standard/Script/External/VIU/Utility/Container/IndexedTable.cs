...
namespace exiii.Unity.VIU.Utility
{
    ...
    public class IndexedTable<TKey, TValue> : IDictionary<TKey, TValue>, IIndexedTableReadOnly<TKey, TValue>
    {
        private class ReadOnlyWrapper : IIndexedTableReadOnly<TKey, TValue>
        {
            ...
            {
                return m_container.GetKeyByIndex(index);
            }

            public TValue GetValueByIndex(int index)
            {
                return m_container.GetValueByIndex(index);
            }

            public bool TryGetValue(TKey key, out TValue value)
            {
                return m_container.TryGetValue(key, out value);
            }

            IEnumerator IEnumerable.GetEnumerator()
            {
                return ((IIndexedTableReadOnly<TKey, TValue>)m_container).GetEnumerator();
            }
        }
        ...
        private class Enumerator : IEnumerator<KeyValuePair<TKey, TValue>>
        {
            ...
            {
                ++iterator; return iterator < container.Count;
            }
