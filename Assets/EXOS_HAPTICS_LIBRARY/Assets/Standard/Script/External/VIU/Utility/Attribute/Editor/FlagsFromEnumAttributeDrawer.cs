...
namespace exiii.Unity.VIU.Utility
{
    ...
    public class FlagsFromEnumAttributeDrawer : PropertyDrawer
    {
        ...
        private static GUIContent GetTextContent(string text)
        {
            s_tempContent.text = text; return s_tempContent;
        }
        ...
        public override void OnGUI(Rect position, SerializedProperty property, GUIContent label)
        {
            ...
            else
            {
                ...
                switch (UnityEngine.Event.current.GetTypeForControl(id))
                {
                    case EventType.MouseDown:
                        if (controlPos.Contains(UnityEngine.Event.current.mousePosition))
                        {
