...
using exiii.Unity.VIU.PoseTracker;
...
{
    public abstract class GrabbableBaseEx<TGrabber> : BasePoseTracker where TGrabber : class, GrabbableBaseEx<TGrabber>.IGrabber
    {
